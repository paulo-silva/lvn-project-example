...
config :tic_tac_toe, TicTacToeWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "pWYYxGoE6F7q/OiBqqTqc/GkLL2Zc44pMHqelSfbuzWi1ZjrW9E8EM1u3RUaVZci",
  watchers: [
...
config :tic_tac_toe, TicTacToeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"lib/tic_tac_toe_web/(live|components)/.*neex$",
      ~r"lib/tic_tac_toe_web/styles/.*ex$",
