defmodule TicTacToeWeb.CoreComponents.SwiftUI do
  @moduledoc """
  ...
  of the `TicTacToeWeb.CoreComponents` functions you should expect identical functionality for similarly named
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TicTacToeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TicTacToeWeb.Gettext, "errors", msg, opts)
    end
  end
