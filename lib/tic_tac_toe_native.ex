defmodule TicTacToeNative do
  ...
  import TicTacToeWeb, only: [verified_routes: 0]
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([TicTacToeWeb, CoreComponents, plugin.module_suffix])
